...
//        self.navigationController?.navigationBar.backIndicatorTransitionMaskImage = R.image.leftArrow2()
    ...
    func navigateToHome() {
//        let newViewController = TabBarController.instantiate(fromAppStoryboard: .main)
//        UIApplication.shared.windows.first!.replaceRootViewControllerWith(newViewController,
