...
extension NSLayoutConstraint {
    ...
    private var originalConstant: CGFloat? {
        ...
        set {
            objc_setAssociatedObject(self,
                                     &NSLayoutConstraint.originalConstantKey, newValue,
    ...
    fileprivate func isHeight() -> Bool {
        ...
        return firstAttribute == .height && secondAttribute ==
            .notAnAttribute && type(of: self) === NSLayoutConstraint.self
    }
    fileprivate func isWidth() -> Bool {
        // without NSSizeLayoutConstraint
        return firstAttribute == .width && secondAttribute ==
            .notAnAttribute && type(of: self) === NSLayoutConstraint.self
    }
...
extension UIView {
    ...
    private var aspectRatioConstraints: [NSLayoutConstraint]? {
        ...
        set {
            objc_setAssociatedObject(self, &UIView.aspectRatioConstraintsKey,
    ...
    private var equalHeightConstraints: [NSLayoutConstraint]? {
        ...
        set {
            objc_setAssociatedObject(self, &UIView.equalHeightConstraintsKey,
                                     newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
    private var equalWidthConstraints: [NSLayoutConstraint]? {
        ...
        set {
            objc_setAssociatedObject(self, &UIView.equalWidthConstraintsKey,
                                     newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
}
...
extension UIView {
    ...
    ///
    public func gone(axis: GVAxis? = nil, spaces: [GVSpace]? = nil, completion:
        (() -> Void)? = nil) {
        isGone = true
    ...
    /// - Parameter completion: Blocks to be executed upon completion.
    public func visible(completion: (() -> Void)? = nil) {
    ...
    private func addConstraint(attribute: NSLayoutConstraint.Attribute, constant: CGFloat) -> NSLayoutConstraint {
        let constraint = NSLayoutConstraint(item: self, attribute: attribute,
